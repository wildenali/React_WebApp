...
const cards = [
  {title: 'Menjadi Web Programmer', imageUrl: 'http://www.wildenali.com/img/kucing.jpg'},
  {title: 'Belajar Pemrograman Javascript', imageUrl: 'http://www.wildenali.com/img/kucing.jpg'},
]
...
const Premium = () => (
 <div className="container pt-2">
     ...
     <div className="col-md-6" style={styles.box450border}>
       {
         features.map(features => (
           <div>
             <h5><strong>{features.strong}</strong></h5>
             <p>{features.desc}</p>
           </div>
         ))
       }
   ...
   <div className="row" style={{ marginTop: 40, marginBottom:100 }}>
     {
       cards.map(card => <Card imageUrl={card.imageUrl} title={card.title} />)
     }
   </div>
